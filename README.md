...
<br/>
KhulnaSoftAI PR-Insight aims to help efficiently review and handle pull requests, by providing AI feedback and suggestions
</div>
...
v0.23 has been released. See full log changes [here](https://github.com/KhulnaSoft/pr-insight/releases/tag/v0.23).
...
Try the GPT-4 powered PR-Insight instantly on _your public GitHub repository_. Just mention `@KhulnaSoftAI-Insight` and add the desired command in any PR comment. The insight will generate a response based on your command.
For example, add a comment to any pull request with the following text:
```
@KhulnaSoftAI-Insight /review
```
...
Comment: `@KhulnaSoftAI-Insight /describe --pr_description.publish_description_as_comment=true` to publish the description as a comment in the PR.
`@KhulnaSoftAI-Insight /review` and `@KhulnaSoftAI-Insight /improve` should work as-is.
...
Note that when you set your own PR-Insight or use KhulnaSoftAI hosted PR-Insight, there is no need to mention `@KhulnaSoftAI-Insight ...`. Instead, directly start with the command, e.g., `/ask ...`.

---


## PR-Insight Pro 💎
[PR-Insight Pro](https://www.khulnasoft.com/pricing/) is a hosted version of PR-Insight, provided by KhulnaSoftAI. It is available for a monthly fee, and provides the following benefits:
...
### KhulnaSoftAI-hosted PR-Insight Pro 💎
...
- KhulnaSoftAI site: https://khulnasoft.com
