...
!!! tip "Review vs. Improve tools comparison"
    ...
    - The [review](https://pr-assistant-docs.khulnasoft.com/tools/review/) tool includes a section called 'Possible issues', that also provide feedback on the PR Code.
