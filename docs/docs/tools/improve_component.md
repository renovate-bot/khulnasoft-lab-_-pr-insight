...
![improve_component1](https://khulnasoft.com/images/pr_assistant/improve_component1.png){width=768}
...
![improve_component2](https://khulnasoft.com/images/pr_assistant/improve_component2.png){width=768}
