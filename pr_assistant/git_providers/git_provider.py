...
class GitProvider(ABC):
    ...
    def get_user_description(self) -> str:
        ...
        if not self._is_generated_by_pr_assistant(description_lowercase):
            get_logger().info("Existing description was not generated by the pr-assistant")
            return description
        ...
        if user_description_header not in description_lowercase:
            get_logger().info("Existing description was generated by the pr-assistant, but it doesn't contain a user description")
            return ""
