...
class BitbucketProvider(GitProvider):
    ...
    def get_repo_settings(self):
        try:
            url = (
                ...
                f"{self.pr.destination_branch}/.pr_insight.toml"
            )
    ...
    # Example: git clone git clone https://bitbucket.org/khulnasoft/pr-insight.git and branch: main -> prefix: "https://bitbucket.org/khulnasoft/pr-insight/src/main", suffix: ""
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        # For example: For repo: https://bitbucket.org/khulnasoft/pr-insight-tests.git
        # clone url will be: https://x-token-auth:<token>@bitbucket.org/khulnasoft/pr-insight-tests.git
