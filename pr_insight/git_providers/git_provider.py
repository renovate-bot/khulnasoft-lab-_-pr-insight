...
class GitProvider(ABC):
    ...
    def clone(
        ...
        try:
            ...
            get_logger().exception(
                f"Clone failed: Could not clone url.",
    ...
    def get_user_description(self) -> str:
        ...
        if user_description_header not in description_lowercase:
            get_logger().info(
                f"Existing description was generated by the pr-insight, but it doesn't contain a user description"
            )
            return ""
        ...
        get_logger().info(
            f"Extracted user description from existing description", description=original_user_description
        )
