...
class GithubProvider(GitProvider):
    ...
    # Example: https://github.com/khulnasoft/pr-insight.git and branch: v0.8 -> prefix: "https://github.com/khulnasoft/pr-insight/blob/v0.8", suffix: ""
    ...
    def get_lines_link_original_file(self, filepath: str, component_range: Range) -> str:
        ...
        link = (
            f"{self.base_url_html}/{self.repo}/blob/{self.last_commit_id.sha}/{filepath}/" f"#L{line_start}-L{line_end}"
        )
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        # https://github.com/Khulnasoft/pr-insight-pro.git
        # Need to embed inside the github token:
        # https://<token>@github.com/Khulnasoft/pr-insight-pro.git
