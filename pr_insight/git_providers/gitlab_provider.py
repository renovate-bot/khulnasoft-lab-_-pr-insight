...
class GitLabProvider(GitProvider):
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        # For example: For repo url: https://gitlab.khulnasoft-inc.com/pr/autoscraper.git
        # Then to clone one will issue: 'git clone https://oauth2:<access token>@gitlab.khulnasoft-inc.com/pr/autoscraper.git'
