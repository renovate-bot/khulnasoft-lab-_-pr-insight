...
async def _perform_commands_bitbucket(commands_conf: str, insight: PRInsight, api_url: str, log_context: dict):
                    ...
                    with get_logger().contextualize(**log_context):
                        ...
                        if get_identity_provider().verify_eligibility("bitbucket",
                            ...
                            if get_settings().get("bitbucket_app.pr_commands"):
                                await _perform_commands_bitbucket("pr_commands", PRInsight(), pr_url, log_context)
