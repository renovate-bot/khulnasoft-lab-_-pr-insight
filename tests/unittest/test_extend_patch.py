...
class TestExtendPatch:
    ...
    def test_happy_path(self):
        ...
        actual_output = extend_patch(
            original_file_str, patch_str, patch_extra_lines_before=num_lines, patch_extra_lines_after=num_lines
        )
    ...
    def test_dynamic_context(self):
        ...
        actual_output2 = extend_patch(
            original_file_str, patch_str, patch_extra_lines_before=1, patch_extra_lines_after=1
        )
        ...
        get_settings(use_context=False).config.allow_dynamic_context = False
        actual_output3 = extend_patch(
            original_file_str, patch_str, patch_extra_lines_before=3, patch_extra_lines_after=3
        )
        expected_output_no_dynamic_context = (
            "\n@@ -7,4 +7,4 @@ def foo():\n     line(5)\n     line(6)\n     line(7)\n-    line(8)\n+    new_line(8)"
        )
