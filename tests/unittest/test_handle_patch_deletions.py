...
class TestHandlePatchDeletions:
    ...
    def test_handle_patch_deletions_happy_path_new_file_content_exists(self):
        ...
        file_name = "file.py"
        assert (
            handle_patch_deletions(patch, original_file_content_str, new_file_content_str, file_name) == patch.rstrip()
        )
    ...
    def test_handle_patch_deletions_edge_case_patch_and_patch_new_are_equal(self):
        ...
        file_name = "file.py"
        assert (
            handle_patch_deletions(patch, original_file_content_str, new_file_content_str, file_name).rstrip()
            == patch.rstrip()
        )
    ...
    def test_handle_patch_deletions_edge_case_patch_and_patch_new_are_not_equal(self):
        ...
        assert (
            handle_patch_deletions(patch, original_file_content_str, new_file_content_str, file_name) == expected_patch
        )
